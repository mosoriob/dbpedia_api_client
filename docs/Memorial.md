...
**date_unveiled** | **list[str]** | Designates the unveiling date | [optional] 
...
**code_memorial** | **list[str]** | Identifier for monuments of the Memorial type | [optional] 
...
**group_commemorated** | **list[str]** | Designates the category of people commemorated by a monument | [optional] 
