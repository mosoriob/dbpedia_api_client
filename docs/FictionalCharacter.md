...
**episode** | **list[str]** | Description not available | [optional] 
...
**last_appearance** | **list[object]** | Description not available | [optional] 
...
**enemy** | **list[object]** | Description not available | [optional] 
...
**eyes** | **list[str]** | Μάτι ονομάζεται το αισθητήριο όργανο της όρασης των ζωντανών οργανισμών. | [optional] 
