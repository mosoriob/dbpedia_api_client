...
**premiere_year** | **list[str]** | Year the play was first performed. | [optional] 
...
**subject_of_play** | **list[str]** | The overall subject matter dealt with by the play. | [optional] 
...
**mute_character_in_play** | **list[str]** | Name of a mute character in play. | [optional] 
**premiere_date** | **list[str]** | Date the play was first performed. | [optional] 
**ibdb_id** | **list[str]** | The Internet Broadway Database ID (IBDB ID) from ibdb.com. | [optional] 
**main_character** | **list[object]** | Description not available | [optional] 
**iobdb_id** | **list[str]** | Lortel Archives Internet Off-Broadway database \&quot;show id\&quot; from lortel.org. | [optional] 
**id** | **str** | identifier | [optional] 
**chorus_character_in_play** | **list[str]** | The name of the (Greek) chorus character in play. | [optional] 
...
**premiere_place** | **list[object]** | The theatre and/or city the play was first performed in. | [optional] 
...
**character_in_play** | **list[str]** | Name of a character in play. | [optional] 
...
**setting_of_play** | **list[str]** | The places and time where the play takes place. | [optional] 
