...
**number_of_vehicles** | **list[int]** | Number of vehicles used in the transit system. | [optional] 
...
**reporting_mark** | **list[str]** | A reporting mark is a two-, three-, or four-letter alphabetic code used to identify owners or lessees of rolling stock and other equipment used on the North American railroad network. | [optional] 
...
**number_of_lines** | **list[int]** | Number of lines in the transit system. | [optional] 
