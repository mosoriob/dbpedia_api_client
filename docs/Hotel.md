...
**number_of_parking_spaces** | **list[int]** | Description not available | [optional] 
...
**number_of_suites** | **list[int]** | Description not available | [optional] 
...
**number_of_restaurants** | **list[int]** | Description not available | [optional] 
...
**number_of_rooms** | **list[int]** | Description not available | [optional] 
...
**star_rating** | **list[float]** | Description not available | [optional] 
...
**chain** | **list[object]** | The chain of Hotels this instance is associated with. | [optional] 
