...
**provost** | **list[object]** | Description not available | [optional] 
...
**campus** | **list[object]** | Πανεπιστημιούπολη εννοείται κάθε πολεοδομικό συγκρότημα που προσφέρει οικιστικές, διδακτικές και ερευνητικές διευκολύνσεις στους φοιτητές ενός πανεπιστημίου. | [optional] 
...
**other** | **list[int]** | Description not available | [optional] 
...
**officer_in_charge** | **list[object]** | Description not available | [optional] 
