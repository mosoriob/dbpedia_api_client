...
------------ | ------------- | ------------- | -------------
**circuit_length** | **list[float]** | Description not available | [optional] 
...
**circuit_name** | **list[str]** | Description not available | [optional] 
...
**number_of_laps** | **list[int]** | Description not available | [optional] 
**race_length** | **list[float]** | Description not available | [optional] 
