...
**added** | **list[str]** | Description not available | [optional] 
...
**nrhp_type** | **list[object]** | Type of historic place as defined by the US National Park Service. For instance National Historic Landmark, National Monument or National Battlefield. | [optional] 
...
**number_of_visitors_as_of** | **list[str]** | The year in which number of visitors occurred. | [optional] 
**localization_thumbnail** | **list[object]** | Description not available | [optional] 
**nrhp_reference_number** | **list[str]** | Description not available | [optional] 
