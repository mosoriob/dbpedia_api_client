...
**mills_code_nl_verdwenen** | **list[str]** | Description not available | [optional] 
...
**grinding_capability** | **list[str]** | grinding capability for Mills | [optional] 
**patron_saint** | **list[object]** | Description not available | [optional] 
**mills_code_nl** | **list[str]** | mills code from the central Dutch database on mills | [optional] 
...
**able_to_grind** | **list[str]** | Description not available | [optional] 
...
**mill_span** | **list[float]** | Description not available | [optional] 
...
**mills_code_nl_windmotoren** | **list[str]** | Description not available | [optional] 
...
**mill_type** | **list[object]** | Description not available | [optional] 
...
**mills_code_be** | **list[str]** | mills code from the Belgian database on mills | [optional] 
...
**mills_code_dutch** | **list[str]** | Description not available | [optional] 
