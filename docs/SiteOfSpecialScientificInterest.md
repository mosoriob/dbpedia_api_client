...
**notify_date** | **list[str]** | Description not available | [optional] 
...
**area_of_search** | **list[object]** | Description not available | [optional] 
...
**interest** | **list[str]** | Description not available | [optional] 
