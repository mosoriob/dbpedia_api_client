...
**number_of_collection_items** | **list[int]** | Indication as to the size of the collection of this library | [optional] 
...
**isil** | **list[str]** | Description not available | [optional] 
