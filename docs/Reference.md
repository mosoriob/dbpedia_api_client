...
Reference to the book or movie the subject is referred to
## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**previous_work** | **list[object]** | Description not available | [optional] 
**connects_referenced_to** | **list[object]** | connects a referenced resource to another resource | [optional] 
...
**at_row_number** | **list[str]** | Row # where the referenced resource is to be found in the source file | [optional] 
...
**at_page** | **list[str]** | Page # where the referenced resource is to be found in the source document | [optional] 
