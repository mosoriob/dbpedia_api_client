...
**dcc** | **list[str]** | The Dewey Decimal Classification is a proprietary system of library classification developed by Melvil Dewey in 1876. | [optional] 
...
**isbn** | **list[str]** | The International Standard Book Number (ISBN) is a unique numeric commercial book identifier based upon the 9-digit Standard Book Numbering (SBN) code. | [optional] 
**cover_artist** | **list[object]** | Cover artist | [optional] 
...
**non_fiction_subject** | **list[object]** | The subject of a non-fiction book (e.g.: History, Biography, Cookbook, Climate change, ...). | [optional] 
...
**number_of_pages** | **list[int]** | The books number of pages. | [optional] 
...
**media_type** | **list[object]** | Print / On-line (then binding types etc. if relevant) | [optional] 
