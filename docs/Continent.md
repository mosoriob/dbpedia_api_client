...
Un continente è una grande area di terra emersa della crosta terrestre, è anzi la più vasta delle ripartizioni con le quali si suddividono le terre emerse.
## Properties
...
**number_of_dependency** | **list[int]** | Description not available | [optional] 
...
**number_of_country** | **list[int]** | Description not available | [optional] 
...
**number_of_city** | **list[int]** | Description not available | [optional] 
