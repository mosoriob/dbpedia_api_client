...
**number_of_piers_in_water** | **list[int]** | Number of piers standing in a river or other water in normal conditions. | [optional] 
...
**number_of_lanes** | **list[int]** | Description not available | [optional] 
...
**vehicles_per_day** | **list[int]** | Description not available | [optional] 
...
**voltage_of_electrification** | **list[float]** | Voltage of the electrification system. | [optional] 
...
**route_end_direction** | **list[str]** | End of the route. The opposite of OntologyProperty:routeStartDirection. | [optional] 
...
**length_reference** | **list[str]** | Description not available | [optional] 
...
**united_states_national_bridge_id** | **list[str]** | Description not available | [optional] 
...
**route_start_location** | **list[object]** | The start location of the route. | [optional] 
...
**toll** | **list[float]** | Description not available | [optional] 
**crosses** | **list[object]** | Description not available | [optional] 
...
**rail_gauge** | **list[float]** | Description not available | [optional] 
...
**route_direction** | **list[str]** | The general direction of the route (eg. North-South). | [optional] 
...
**route_end** | **list[object]** | End of the route. This is where the route ends and, for U.S. roads, is either at the northern terminus or eastern terminus. | [optional] 
...
**type_of_electrification** | **list[object]** | Electrification system (e.g. Third rail, Overhead catenary). | [optional] 
...
**railway_rolling_stock** | **list[object]** | Description not available | [optional] 
**is_part_of_route** | **list[str]** | Name of another route from which the route is part of. Infobox property values are mostly given as plain text, therefore range is xsd:string. | [optional] 
...
**route_start_direction** | **list[str]** | End of the route. For U.S. roads, this should be either \&quot;South\&quot; or \&quot;West\&quot; per the standards set by the U.S. Roads project. | [optional] 
...
**number_of_stations** | **list[int]** | Number of stations or stops. | [optional] 
...
**track_length** | **list[float]** | Length of the track. Wikipedians usually do not differentiate between track length and line lenght. | [optional] 
...
**route_start** | **list[object]** | Start of the route. This is where the route begins and, for U.S. roads, is either at the southern terminus or western terminus. | [optional] 
...
**bridge_carries** | **list[str]** | Type of vehicles the bridge carries. | [optional] 
...
**route_junction** | **list[object]** | A junction or cross to another route. | [optional] 
**number_of_spans** | **list[int]** | Number of spans or arches. | [optional] 
...
**route_end_location** | **list[object]** | The end location of the route. | [optional] 
...
**mainspan** | **list[float]** | Description not available | [optional] 
...
**speed_limit** | **list[float]** | Description not available | [optional] 
...
**route_number** | **list[str]** | The number of the route. | [optional] 
...
**route_type_abbreviation** | **list[str]** | The route type abbreviation (eg.: I for Interstate, M for Motorway or NJ for New Jersey Route). | [optional] 
...
**load_limit** | **list[float]** | Load limit of the bridge. | [optional] 
...
**line_length** | **list[float]** | Length of the line. Wikipedians usually do not differentiate between track length and line lenght. | [optional] 
