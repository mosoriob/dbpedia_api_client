...
**album_runtime** | **list[float]** | Description not available | [optional] 
**main_character** | **list[object]** | Description not available | [optional] 
**total_tracks** | **list[int]** | the total number of tracks contained in the album | [optional] 
**review** | **list[str]** | Description not available | [optional] 
**record_date** | **list[str]** | Description not available | [optional] 
**id** | **str** | identifier | [optional] 
**compiler** | **list[object]** | For compilation albums: the person or entity responsible for selecting the album&#39;s track listing. | [optional] 
**based_on** | **list[object]** | Description not available | [optional] 
**longtype** | **list[str]** | can be used to include more informations e.g. the name of the artist that a tribute album is in honor of | [optional] 
...
**total_discs** | **list[int]** | the total number of discs contained in the album | [optional] 
**production_company** | **list[object]** | the company that produced the work e.g. Film, MusicalWork, Software | [optional] 
**music_format** | **list[str]** | The format of the album: EP, Single etc. | [optional] 
