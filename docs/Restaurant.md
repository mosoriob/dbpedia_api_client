...
**head_chef** | **list[object]** | Description not available | [optional] 
...
**reservations** | **list[bool]** | Are reservations required for the establishment or event? | [optional] 
...
**dress_code** | **list[str]** | The recommended dress code for an establishment or event. | [optional] 
...
**chef** | **list[object]** | Description not available | [optional] 
**cuisine** | **list[str]** | Description not available | [optional] 
